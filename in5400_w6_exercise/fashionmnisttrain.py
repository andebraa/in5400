...
def datasetup():
  ...
  dataPath = './data/MNIST_fashion/' #'/projects/in5400/MNIST_fashion/'
...
def hook_factory(outputpath, filestub):
    ...
    def ahook(module, input_, output):
        ...
        print(output)
        # after using outputpath, filestub it should depend only on module, input_, output
        return None
