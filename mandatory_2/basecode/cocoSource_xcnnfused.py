...
class RNN_onelayer_simplified(nn.Module):
    ...
    def forward(self, xTokens, baseimgfeat, initial_hidden_state, outputlayer, Embedding, is_train=True):
        ...
        for kk in range(seqLen):
            ...
            #TODO
            lvl0input = baseimgfeat # Either this, or initial_hidden_state, as level zero input
            ...
            #TODO
            updatedstate[0,:] = self.cells[0].forward(lvl0input, updatedstate)  #RNN cell is used here #uses lvl0input and the hiddenstate
